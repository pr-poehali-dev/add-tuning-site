...
const WhyChooseUs = () => {
  const advantages = [
    ...
    },
    {
      ...
      description: 'Всегда сохраняю оригинальный файл ЭБУ — при необходимости верну всё как было бесплатно.'
    },
    {
      icon: 'Database',
    ...
    },
    {
      ...
      description: 'Показываю процесс работы. Даю копию файла калибровки. Никаких скрытых платежей — цена известна до начала работ.'
    },
    {
      icon: 'MessageSquare',
