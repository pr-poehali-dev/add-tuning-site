  ...
  const reviews = [
    {
      ...
      rating: 5,
      date: '15.10.2024',
      text: 'Отличная работа! Машина преобразилась после Stage 1. Динамика стала совершенно другой, при этом расход не увеличился. Ребята профессионалы своего дела, все объяснили и показали. Рекомендую!',
      initials: 'ДК'
    },
    {
      name: 'Александр М.',
    ...
    },
    {
      ...
      rating: 5,
      date: '25.09.2024',
      text: 'Прошивали GTI на Stage 1. Машина получила +65 л.с. и стала настоящим зверем! Ребята знают свое дело, все сделали аккуратно. Диагностика показала, что все параметры в норме.',
      initials: 'СВ'
    },
    {
      name: 'Михаил П.',
      ...
      rating: 5,
      date: '18.09.2024',
      text: 'Обратился для эко-тюнинга. Расход действительно снизился на 15-20%, при этом мощность не потерял. Очень грамотные специалисты, рекомендую всем!',
      initials: 'МП'
    },
    {
      name: 'Андрей Л.',
        ...
        <div className="container mx-auto">
          <div className="max-w-3xl mx-auto text-center mb-16 animate-fade-in">
            ...
            <p className="text-xl text-muted-foreground">
              Реальные отзывы владельцев автомобилей, которые доверили нам чип-тюнинг
            </p>
          </div>
