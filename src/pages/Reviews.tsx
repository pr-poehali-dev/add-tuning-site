...
const Reviews = () => {
  const reviews = [
    ...
    {
      name: 'Александр М.',
      car: 'Toyota Camry V50',
      rating: 5,
      date: '08.10.2024',
      text: 'После ДТП загорелась ошибка подушек безопасности. Восстановили блок SRS и почистили Crash data. Все сделали быстро и качественно. Ошибка больше не появляется. Спасибо за профессионализм!',
      initials: 'АМ'
    },
    {
      name: 'Игорь С.',
