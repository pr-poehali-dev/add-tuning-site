...
const Myths = () => {
  const myths = [
    ...
    },
    {
      ...
      fact: 'У нас было 15 случаев за год, когда к нам приезжали после "гаражной" прошивки восстанавливать ЭБУ. Стоимость восстановления — от 15 000 ₽.'
    },
    {
      icon: 'XCircle',
    ...
    },
    {
      ...
      reality: 'Частично правда для старых АКПП. Современные коробки DSG, Aisin, ZF рассчитаны с запасом и спокойно держат +30% момента. Проблемы бывают у старых "автоматов" 90-х годов и вариаторов с пробегом 200+ тыс. км. Мы предупреждаем о рисках заранее, если видим изношенную коробку на диагностике.',
            ...
            <Card className="bg-gradient-to-br from-primary/10 to-primary/5 border-primary/30">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-muted-foreground mb-6">
                  Я готов честно ответить на любые вопросы о чип-тюнинге. 
                  Позвоните или напишите — расскажу про ваш автомобиль конкретно.
                </p>
